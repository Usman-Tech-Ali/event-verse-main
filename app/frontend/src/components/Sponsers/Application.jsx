...
const ApplyForSponsorship = () => {
  ...
  const handleSponsorshipDetailsChange = (eventId, field, value) => {
    setSponsorshipDetails((prev) => ({
      ...prev,
      [eventId]: {
        ...prev[eventId],
        [field]: value,
    ...
    >
      ...
      <header className="text-center py-10">
        <h1 className="text-4xl sm:text-5xl font-extrabold mb-6 animate-bounce">
          Apply for <span className="text-yellow-400">Sponsorship</span>
        </h1>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  />
                  <button
                    onClick={() => handleSponsorshipSubmission(event)}
